 ...
 */
class AllocPageLogRecord extends LogRecord {
    private long transNum;
    private long pageNum;
    private long prevLSN;

    AllocPageLogRecord(long transNum, long pageNum, long prevLSN) {
    ...
    public Pair<LogRecord, Boolean> undo(long lastLSN) {
        return new Pair<>(new UndoAllocPageLogRecord(transNum, pageNum, lastLSN, prevLSN), true);
    }
